...
import classes from "../components/to-visit-comment-form-styles.module.css"
function ToVisitCommentForm() {
    ...
    return (
        <div>
            <h2 className={classes.center}>What places should I go next?</h2>
...
export default ToVisitCommentForm;